...
class RepoGeneratorSpec extends FeatureSpec with GivenWhenThen {
  ...
  feature("slidings") {
    ...
    scenario("4 elments in 3") {
      ...
      assertResult(Seq(Seq(4), Seq(2), Seq(3, 1)))(result)
    }
    ...
    scenario("1 elments in 3") {
      ...
      assertResult(Seq(Nil, Seq(1), Nil))(result)
    }
    ...
    scenario("2 elments in 5") {
      ...
      assertResult(Seq(Nil, Seq(1), Seq(1), Nil, Nil))(result)
    }
    ...
    scenario("2 elments in 4") {
      ...
      assertResult(Seq(Nil, Seq(1), Seq(7), Nil))(result)
    }
  }
